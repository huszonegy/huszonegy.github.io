...
- 8–12 fejezet, legalább 3–5 perces közökkel; az időbélyeg formátuma `MM:SS` (leading zero az egyjegyű perceknél is, pl. `00:00`, `05:55`); az időbélyeg után csak szóköz, gondolatjel nélkül.
...
8. **Firefish 🔥🐟 Bitcoin fedezetű kölcsön:**
   - Magyar platform ➡ https://app.firefish.io/auth/sign-up
   - Ajánlókód: HUSZONEGY
9. **Az epizód oldala** — a leírás legutolsó sora, egy darab CTA:
   - `Átiratra vágysz? ➡ https://huszonegy.world/podcast/<slug>/`
...
4. **Stílus:**
   - Karikatúra-rajz (ha van vendég-cutout) vagy tisztán illusztratív (ha nincs).
...
5. **Kompozíció:**
   ...
   - **Mindig számolok a 260×146-os kicsinyítéssel** — a sziluettek és a kicker kis méretben is olvashatóak maradjanak.
...
8. **Méretek emlékeztető a briefben:**
   ...
   - 260×146 a `public/pics/eXXX.jpg`-hez (én átméretezem utólag).

**Kicker-konvenció:**
- **Tartalmilag:** provokál, fél-tét; a YouTube-cím oldja fel. Teljes címet NEM ismétli.
- **Hossz:** max 3–5 szó (kis méretben olvashatóság).
- **Tipográfia:** **all caps** (csupa nagybetű), **bold sans-serif** font (vizuális tömeg).
- **Szín:** fehér (vagy egyéb, a háttérhez képest magas-kontrasztú szín).
- **Pozíció:** felső harmad vagy felső sáv — ne nyomja a vendég-arcot, és az alsó YouTube-időtartam-bar ne fedje le.
...
**Átméretezés:** az enyém — 1280×720 (Árpi tölti fel YouTube/Spotify/Rumble), és 260×146 a `public/pics/eXXX.jpg`-hez. Leegyeztetem Árpival, hogy hová mentem az 1280x720-as jpg-t.
