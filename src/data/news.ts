...
export const news = [
    {
        summary: "Meetup szeptemberben, előadásokkal!",
        date: "2025.08.27.",
        html: "Egy rendhagyó meetupra hívunk Téged szeptemberben! <br/><br/> Ha a szíved mélyén érzed, hogy a bitcoin egy jó dolog, de a fejedben több a kérdés, mint a válasz; vagy csak szeretnél más magyar bitcoinerekkel csevegni, szeretettel várunk. Több előadással készülünk, de lesz idő beszélgetésre is. <br/> Különleges alkalom, hogy Kovács Ferenc, az egyik legismertebb magyar bitcoiner arc is ellátogat hozzánk! Feri előadásai és népszerű rövid videói révén is ismert (https://bitcoinmiskolc.hu/galeria/ https://www.tiktok.com/@ferenckovacs85), de ő a BitcoinMiskolc elindítója, és az első bitcoin-tartalékkal bíró magyar cégcsoport vezetője is. <br/><br/> Regisztráció: A létszám miatt kérünk regisztrálj ezen a linken (a név lehet becenév, email meg bármi): <br/><a href='https://bitcoinszeptember25.rsvpify.com'>bitcoinszeptember25.rsvpify.com</a> <br/><br/> Időpont:  <strong> szeptember 18 </strong> (csütörtök), 18:00 <br/> Helyszín: Budapest, XI. kerület, Bocskai & Karolina út környéke (pontos cím később / a telegram csoportban). <br/><br/> Tervezett Program: <br/> 18:00 Érkezés <br/> 18:30 - 18:40 Köszöntő, a Huszonegy csoport rövid bemutatása -- OptOut (lelkes 21-es, freedom tech fejlesztő) <br/> 18:45 - 19:10 Saját tárca létrehozása és kiutalás CEX-ről, gyakorlati bemutató. Előadó: Five, Nostr fejlesztő. <br/> 19:15 - 19:40 Magyar Bitcoin stratégia a gyakorlatban magánszemélyként és vállalkozóként Előadó: Kovács Ferenc, bitcoin maxi, mérnök, vállalkozó, a Bitcoin Miskolc elindítója, arról fog beszélni, hogy miért épít bitcoin tartalékot cégeinek és családjának (KV cégcsoport, Hotel Auróra, Hotel Atlantis). <br/> 19:45 - 20:10 Nostr - közösségépítés cenzúra nélkül. Hogyan alkalmazható a bitcoin filozófiája az online kommunikációban? Előadó: Lez, freedom tech builder, '\"nostrucc\". <br/> 20:15 - 22:00 Kötetlen beszélgetés. <br/> A program változhat! <br/><br/> Bővebb információ a Telegram csoportban. <br/> További jó hír, hogy a közeljövőben kéthavonta tervezzük folytatni a tematikus előadás-sorozatot, újabb lehetőséget teremtve ezzel a tanuláshoz, informálódáshoz és kapcsolódáshoz. <br/> A bitcoinra koncentrálunk, egyéb kriptókat ignoráljuk. Lesz inni és csipegetnivaló, de nyugodtan hozhatsz magadnak is vagy megosztani. A részvétel ingyenes. Parkolás az utcában, környéken megoldható. <br/><br/> Linkek: https://huszonegy.world https://t.me/huszonegy https://bitcoinplebs.org/the-journey-begins/ https://www.tiktok.com/@ferenckovacs85 https://bitcoinmiskolc.hu/galeria https://nostr.hu/ https://bitcointreasuries.net/private-companies/kv-cgcsoport",
    },
    {
