...
export const books = [
    {
        ...
        shop: "<a href='https://bookline.hu/search/search.action?page=1&searchfield=kis+bitcoin+k%C3%B6nyv' target='_blank'>BookLine</a> és <a href='https://shop.bitcoinbazis.hu/termek/a-kis-bitcoin-konyv/' target='_blank'>BitcoinBázis</a> (bitcoinért is)"
    },
    {
        ...
        shop: "A legtöbb magyarországi könyesbolt és <a href='https://shop.bitcoinbazis.hu/termek/bitcoin-standard-a-kozponti-bankok-decentralizalt-alternativaja-2-kiadas/' target='_blank'>BitcoinBázis</a> (bitcoinért is)"
    },
    {
        ...
        shop: "<a href='https://shop.bitcoinbazis.hu/termek/bitcoin-szuverenitas-fuggetlenseg/' target='_blank'>BitcoinBázis</a> (bitcoinért is)"
    }
]
